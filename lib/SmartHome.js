...
class GoogleSmartHome {
    /**
     * Constructor for GoogleSmartHome
     *
     * @param {import('../google-mgmt').MgmtNode} mgmtNode - Management node
     * @param {string} nodeId - ID of the config node
     * @param {string} userDir - User directory
     * @param {string} httpNodeRoot - HTTP node root
     * @param {boolean} useGoogleLogin - Use Google login
     * @param {string} googleClientId - Google client ID
     * @param {Array} emails - Emails
     * @param {string} username - Username
     * @param {string} password - Password
     * @param {number} accessTokenDuration - Access token duration
     * @param {boolean} usehttpnoderoot - Use HTTP node root
     * @param {string} httpPath - HTTP path
     * @param {number} httpPort - HTTP port
     * @param {string} localScanType - Local scan type
     * @param {number} localScanPort - Local scan port
     * @param {number} httpLocalPort - HTTP local port
     * @param {boolean} nodeRedUsesHttps - Node-RED uses HTTPS
     * @param {boolean} ssloffload - SSL offload
     * @param {string} publicKey - Public key
     * @param {string} privateKey - Private key
     * @param {string} jwtkeyFile - JWT key file
     * @param {string} clientid - Client ID
     * @param {string} clientsecret - Client secret
     * @param {number} reportStateInterval - Report state interval
     * @param {number} requestSyncDelay - Request sync delay
     * @param {number} setStateDelay - Set state delay
     * @param {boolean} debug - Debug flag
     * @param {Function} debug_function - Debug function
    ...
    /**
     * Unregisters URLs from the Node-RED application.
     *
     * @param {object} REDapp - The Node-RED application instance.
     */
    ...
    StartUDPDeviceScanServer() {
         ...
         * @param {object} info - Remote address information.
         */
        ...
        function onListening() {
            ...
            me.debug(`Service Scan UDP server: listening on: ${this.type} ${address.address}:${address.port}`);
        }
     ...
     *
     * @param {object} REDapp - The Node-RED application instance.
     * @param {object} REDserver - The Node-RED server instance.
     * @returns {boolean|string} True if started successfully, otherwise an error message.
     */
    ...
    /**
     * Gets custom data for local fulfillment.
     * The custom data contains additional information for the app.js script to connect to Node-RED.
     *
     ...
     *
     * @returns {boolean} True if the HTTP server is running, otherwise false.
     */
    IsHttpServerRunning() {
