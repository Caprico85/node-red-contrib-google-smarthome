...
export default class HttpActions {
     ...
     *
     * @param {string} httpRoot - HTTP root path
     * @param {object} appHttp - Express application instance
     */
    ...
    /**
     * Registers HTTP routes for local fulfillment.
     *
     * @param {string} httpLocalRoot - Local HTTP root path
     * @param {object} appHttp - Express application instance
     */
     ...
     * @param {Response} response - Express response object
     * @param {boolean} is_local - Is local execution
     * @returns {object} Response object
     * @private
     */
     ...
     * @param {Array} devices - Devices
     * @param {Response} response - Express response object
     * @returns {Array} Reachable devices
     * @private
     */
