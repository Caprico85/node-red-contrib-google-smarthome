...
class HttpAuth {
    ...
    httpAuthRegister(httpRoot, appHttp) {
         ...
         * 
         * This is called:
         * - After the user has entered their credentials in the login form and clicked "Login".
         ...
         *   Request contains no relevant headers or query parameters, but a body with the parameters: username, password, client_id, redirect_uri, state, id_token
         * 
         * Available parameters:
         * - username: The username entered by the user in the login form
         * - password: The password entered by the user in the login form
         * - client_id: The client ID we registered our project with at Google
         * - redirect_uri: The URL to which the user is redirected after the login process
         * - state: A random string for CSRF protection, which is passed back to Google unchanged
